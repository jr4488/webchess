...
vi.mock('./lib/openclaw-webchess-api', async (importOriginal) => {
  const actual = await importOriginal<typeof import('./lib/openclaw-webchess-api')>()
  return {
    ...actual,
...
describe('local OpenClaw WebChess experience', () => {
  ...
  it('restores browser-local state and explains the local provider boundary', async () => {
    render(<OpenClawApp />)
