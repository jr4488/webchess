export const WEBCHESS_SOFTWARE_VERSION = '2.0.0' as const
export const WEBCHESS_LIFECYCLE_VERSION = 'webchess-lifecycle-v2' as const
export const PORTIA_PROMPT_VERSION = 'webchess-portia-v1' as const
export const PORTIA_CONTRACT_VERSION = 'webchess-portia-review-v1' as const
export const GATE_ALGORITHM_VERSION = 'webchess-gate-v1' as const
export const RETRY_POLICY_VERSION = 'webchess-retry-v1' as const
export const CHARLOTTE_PROMPT_VERSION = 'webchess-charlotte-v1' as const
