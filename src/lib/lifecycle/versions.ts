...
export const WEBCHESS_LIFECYCLE_VERSION = 'webchess-lifecycle-v2.3' as const
export const PORTIA_PROMPT_VERSION = 'webchess-portia-v3' as const
export const PORTIA_CONTRACT_VERSION = 'webchess-portia-review-v2' as const
export const GATE_ALGORITHM_VERSION = 'webchess-gate-v3' as const
